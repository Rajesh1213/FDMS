FinacialDataManagementSystem::Application.routes.draw do
  ...
  get "transactions/download_transaction_pdf", "mi_transactions/download_transaction_pdf", "df_transactions/download_transaction_pdf", "di_transactions/download_transaction_pdf"
